							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="rcol-xs-10 col-sm-5" id="remark" name="remark" value="<?php echo ($member["remark"]); ?>" placeholder="备注">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<?php if($member['group_id'] == 2): ?><select id="group_id" name="group_id" class="rcol-xs-10 col-sm-5" >
													<option value="2">一级代理商</option>
											</select>
										<?php elseif($member['group_id'] == 3): ?>
											<select id="group_id" name="group_id" class="rcol-xs-10 col-sm-5" >
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select id="cps_type" name="cps_type" class="rcol-xs-10 col-sm-5">
													<?php if(is_array($cpstype)): $k = 0; $__LIST__ = $cpstype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>" <?php if($k == $member['cps_type']): ?>selected="selected"<?php endif; ?>><?php echo ($val); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
										<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
									...
									<?php if($user['gid'] == 1): ?><div class="form-group">
											...
											<div class="col-sm-9">
												<div class="checkbox">
													<label for="enable_deduct">
														<input type="checkbox" name="enable_deduct" id="enable_deduct"<?php if($member['enable_deduct']): ?>checked<?php endif; ?> value="1">是
													</label>
												</div>
											</div>
										</div>
										...
										<?php if($gid == 1 && $member['group_id'] == 2): ?><div class="form-group">
												<label class="col-sm-1 control-label no-padding-right" for="enable_deduct"> 可创建一级代理商 </label>
												<div class="col-sm-9">
													<div class="checkbox">
														<label for="enable_deduct">
															<input type="checkbox" name="valve"  <?php if($member['valve'] ==2): ?>checked<?php endif; ?> value="1">是
														</label>
													</div>
												</div>
											</div>
										...
										<?php if(($user['gid'] == 1)): ?><div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="checkbox">
														<label for="enable_deduct">
															<input type="number" name="begin_kl_time" value="<?php echo ($member['begin_kl_time']); ?>">
														</label>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="checkbox">
														<label for="enable_deduct">
															<input type="number" name="kl_min_s" value="<?php echo ($member['kl_min_s']); ?>">
														</label>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="checkbox">
														<label for="enable_deduct">
															<input type="number" name="kl_max_s" value="<?php echo ($member['kl_max_s']); ?>">
														</label>
													</div>
												</div>
											</div>
                                          ...
                                          <div class="col-sm-9">
                                            <div class="checkbox">
                                              <label for="login_lock">
                                                <input type="radio" name="login_lock" id="login_lock"<?php if($member['login_lock'] != 1): ?>checked<?php endif; ?> value="0">锁定
                                              </label>
                                            <label for="login_lock">
                                                <input type="radio" name="login_lock" id="login_lock"<?php if($member['login_lock'] == 1): ?>checked<?php endif; ?> value="1">开启
                                              </label>
                                          </div>
                                        </div>
                                    </div>
									...
									<?php if($user['gid'] == 2 && !empty($user['enable_deduct'])): ?><div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="deduct_rate" id="deduct_rate" placeholder="比例" class="col-xs-10 col-sm-5" value="<?php echo ($member['deduct_rate']); ?>">
												<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="alipay_number" id="alipay_number" placeholder="支付宝账号" class="col-xs-10 col-sm-5" value="<?php echo ($member['alipay_number']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
										</div>
									...
									<!--</div>--><!--
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="wei_number" id="wei_number" placeholder="微信账号" class="col-xs-10 col-sm-5" value="<?php echo ($member['wei_number']); ?>">
												<span class="help-inline col-xs-12 col-sm-7">
													<span class="middle"></span>
												</span>
											</div>
										...
										<div class="space-4"></div>
<?php if(in_array($user['uid'],C('FINANCE_IDS'))): ?><!--<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="scale" id="scale" placeholder="分成比例" class="col-xs-10 col-sm-5" value="<?php echo ($member['scale']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
											</div>
...
<!--
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="alipay_name" id="alipay_name" placeholder="支付宝账户" class="col-xs-10 col-sm-5" value="<?php echo ($member['alipay_name']); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
											</div>
...
<![endif]-->
		...
		<script src="/Public/Ln/js/function.js"></script>
		<script type="text/javascript">
		jQuery(function($){
			$('#birthday').datepicker({
				  format: 'yyyy-mm-dd',
