			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="row">
							<form class="form-inline" method="post" action="<?php echo U('lostorder');?>">
								<div class="input-group ">
									<select name="pay" style="margin: 0 0 0 12px">
										<option value="1">订单号</option>
										<option value="2" <?php if(($search['pay'] == 2)): ?>selected<?php endif; ?> >第三方订单号</option>
									</select>
								</div>
								<input class="form-control" name="pay_list" value="<?php echo ($search['pay_list']); ?>" type="text"/>
								<label class="inline">&nbsp;&nbsp;推广商ID</label>
								<input class="form-control" name="ref_id" value="<?php echo ($search['ref_id']); ?>" type="text"/>
								<label class="inline">&nbsp;&nbsp;开始日期：</label>
								<div class="input-group ">
									<input class="form-control" id="startime" value="<?php echo ($search['stime']); ?>" name="stime" type="text" data-date-format="dd-mm-yyyy" />
								...
								<div class="input-group ">
									<input class="form-control" id="entime" value="<?php echo ($search['etime']); ?>" name="etime" type="text" data-date-format="dd-mm-yyyy" />
									<span class="input-group-addon">
											<i class="ace-icon fa fa-calendar bigger-110"></i>
										</span>
								</div>
								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<tbody>
										<tr>
											...
											<td><?php echo ($order['ref1_id']); ?></td>
											<td><?php echo ($order['ref1_name']); ?></td>
											<td><?php echo ($order['ref2_id']); ?></td>
											<td><?php echo ($order['ref2_name']); ?></td>
											<td><?php echo ($order['pay_amount']); ?>元</td>
											<td><?php echo ($order['pay_serial']); ?></td>
											<td><?php echo ($order['pay_time']); ?></td>
											<td><?php echo ($order['kouliang']); ?></td>
											<td>
												<?php if((isset($order)) and ($order["account"] == 0)): ?><a href="<?php echo U('orderaccount',array('account'=>1,'id'=>$order['id']));?>">扣量恢复</a>
												<?php elseif($order["account"] == -1): ?>
													<form action="<?php echo U('Tg/orderaccount');?>" method="get" id="orderform">
												...
												<a href="<?php echo U('updateaccount',array('id'=>$order['id']));?>">修改</a>
											</td>
										</tr>
									</tbody>
								</table>
