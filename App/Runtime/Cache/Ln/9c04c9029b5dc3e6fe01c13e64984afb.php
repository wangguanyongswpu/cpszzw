                    ...
                    <div class="col-xs-12">                                <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" action="<?php echo U('update');?>" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" id="name" class="rcol-xs-10 col-sm-5" value="">
                            ...
                            <div class="form-group"><label class="col-sm-1 control-label no-padding-right">AppID </label>
                                <div class="col-sm-9">
                                    <input type="text" name="app_id" id="app_id" class="col-xs-10 col-sm-5" value="">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group"><label class="col-sm-1 control-label no-padding-right"> AppSecret </label>
                                <div class="col-sm-9">
                                    <input type="text" name="secret" id="secret" class="col-xs-10 col-sm-5" value="">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group"><label class="col-sm-1 control-label no-padding-right"> 微信支付商户号 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="merchant_id" id="merchant_id" class="col-xs-10 col-sm-5" value="">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="key" id="key" class="col-xs-10 col-sm-5" value="">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="api_url" id="api_url" class="col-xs-10 col-sm-5" value="">
                                        <span class="help-inline col-xs-12 col-sm-7">
                                            <span class="middle"></span>
                                        </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="web_id" id="web_id" class="col-xs-10 col-sm-5" value="">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="web_url" id="web_url" class="col-xs-10 col-sm-5" value="">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="no-padding-left">
                                    ...
                                    <label class="checkbox-inline">
                                        <input type="radio" name="status" value="3" checked="checked"> 待用
                                    </label>
                                </div>
                                <span class="help-inline col-xs-12 col-sm-7">
                                    <span class="middle"></span>
