							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group">
										<label class="block col-sm-1 control-label no-padding-right" for="form-field-1"> 网站标题：</label>
										<div class="col-sm-9 block">
											<input type="text" name="title" id="title" placeholder="网站标题" class="block col-xs-10 col-sm-5" value="<?php echo (C("title")); ?>">
											<span class="block help-inline col-xs-12 col-sm-7 ">
									...
									<div class="form-group">
										<label class="block col-sm-1 control-label no-padding-right" for="form-field-1"> 网站SEO标题：</label>
										<div class="col-sm-9">
											<input type="text" name="sitename" id="sitename" placeholder="网站SEO标题" class="block col-xs-10 col-sm-5" value="<?php echo (C("sitename")); ?>">
											<span class="block help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										<label class="block col-sm-1 control-label no-padding-right" for="form-field-2"> 关键词：</label>
										<div class="col-sm-9">
									...
									<div class="form-group">
										<label class="block col-sm-1 control-label no-padding-right" for="form-field-2"> 网站描述：</label>
										<div class="col-sm-9">
											<textarea name="description" id="description" placeholder="网站描述" class=" block col-xs-10 col-sm-5" rows="5"><?php echo (C("description")); ?></textarea>
											<span class="block help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										<label class="block col-sm-1 control-label no-padding-right" for="form-field-2"> 底部内容：</label>
										<div class="col-sm-9">
											<textarea name="footer" id="footer" placeholder="底部内容" class="block col-xs-10 col-sm-5" rows="5"><?php echo (C("footer")); ?></textarea>
											<span class="block help-inline col-xs-12 col-sm-7">
									...
									<?php if(is_array($vars)): $i = 0; $__LIST__ = $vars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="form-group">
										...
										<div class="col-sm-9">
											<?php if($val["data"] == '' ): ?><input type="text" name="<?php echo ($val["k"]); ?>" id="<?php echo ($val["k"]); ?>" placeholder="变量值" class="block col-xs-10 col-sm-5" value="<?php echo ($val["v"]); ?>">
												<?php else: ?>
												<select id="style" name="<?php echo ($val["k"]); ?>" class="rcol-xs-10 col-sm-5">
													<?php if(is_array($val["data"])): foreach($val["data"] as $key=>$vo): ?><option value="<?php echo ($key); ?>" <?php if($key == $val["v"] ): ?>selected="selected"<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; ?>
												</select><?php endif; ?>
											<span class="block help-inline col-xs-12 col-sm-7">
									...
									<div class="col-md-offset-2 col-md-9">
										<button class="btn btn-info submit btn-line" type="button">
											<i class="icon-ok bigger-110"></i>
											提交
										</button>

										&nbsp; &nbsp; &nbsp;
										<button class="btn btn-line" type="reset">
