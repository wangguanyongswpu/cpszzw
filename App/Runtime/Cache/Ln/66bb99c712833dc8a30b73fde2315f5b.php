    ...
    <div class="main-content">
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <form class="form-inline" action="<?php echo U('user');?>" method="get" id="search-form">
...
<![endif]-->
    ...
    <script src="/Public/Ln/js/echarts.min.js"></script>
    ...
    var option = {
		...
		xAxis : [
			{
				type : 'category',
				data : [<?php  foreach($data as $key=>$val) { echo "'".$key."',"; } ?>]
			}
		],
		yAxis : [
			{
		...
		series : [
			{
				name:'总充值金额',
				type:'bar',
				data:[<?php  foreach($data as $val) { echo $val['pay_amount'].","; } ?>],
				markPoint : {
					data : [
						{type : 'max', name: '最大值'},
						{type : 'min', name: '最小值'}
			...
			},
			{
				name:'充值用户数',
				type:'bar',
				data:[<?php  foreach($data as $val) { echo $val['pay_num'].","; } ?>   ],
				markLine : {
					data : [
						{type : 'average', name : '平均值'}
					]
			...
			},
			{
				name:'未充值用户数',
				type:'bar',
				data:[<?php  foreach($data as $val) { echo $val['no_pay_num'].","; } ?>],
				markLine : {
					data : [
						{type : 'average', name : '平均值'}
					]
